import { ItemView, type WorkspaceLeaf, Notice, setIcon } from "obsidian";
...
export class ChatView extends ItemView {
  ...
  private handleThinkingMessage(message: AgentMessage): void {
    ...
    const contentEl = this.streamingThinkingEl.querySelector<HTMLElement>(
      ".ac-thinking-content",
    );
    if (contentEl) {
  ...
  private onGenerationComplete(): void {
    ...
    if (this.streamingMessageEl) {
      const body =
        this.streamingMessageEl.querySelector<HTMLElement>(".ac-message-body");
      if (body) {
